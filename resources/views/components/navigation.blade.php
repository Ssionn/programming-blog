    ...
    <div class="pt-10 flex flex-col md:flex-row justify-between">
        ...
        <div class="mt-10 md:mt-0 flex justify-center">
            <ul class="flex flex-row space-x-4 sm:space-x-8 lg:space-x-24 sm:mr-8 md:mr-16 mr-3 items-center">
                <li>
                    <x-active-link :active="request()->routeIs('blogpost.index')" href="{{ route('blogpost.index') }}" class="font-semibold text-gray-600 hover:text-gray-800">Home</x-active-link>
                </li>
                <li>
                    <x-active-link :active="request()->routeIs('blogpost.all')" href="{{ route('blogpost.all') }}" class="font-semibold text-gray-600 hover:text-gray-800">All Posts</x-active-link>
                </li>
